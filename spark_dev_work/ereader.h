...
#else
const int EPD_PANEL_ON = D2; // V3 or higher
const int EPD_BORDER = D3;   // V3 of higher
//const int UP_PIN = ;        // INT0
//const int DOWN_PIN = ;
//const int SEL_PIN = ;       // INT1
//const int MODE_PIN = ;
#endif

const int LED_PIN = A7;
const int EPD_DISCHARGE = D4;
//const int EPD_PWM = D5;
const int EPD_PWM = A7;
const int EPD_RESET = D6;
const int EPD_BUSY = D7;
const int EPD_EPD_CS = D0;
const int EPD_FLASH_CS = D1;
const uint8_t UNIFONT_RECLEN = 33;
// const int SD_CS = 10; // delete me!
const int SD_CS = A2; // production
